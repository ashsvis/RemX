...
//===================================
  ...
  public
    ...
    NoAsk: boolean; // добавлено 15.07.12
...
begin
  ...
  DigErrFilter := False;
  NoAsk := False; // добавлено 15.07.12
end;
          ...
          begin
            ...
            begin
              ...
              try
                ...
                // Пустышка, только вычитывается из потока, в базу не добавляется !
...
//  E.ErrorMess:=AAlarmState[AKind];
  ...
  begin
    if Caddy.NoAsk then                        // добавлено 15.07.12
      E.ConfirmStatus:=E.ConfirmStatus+[AKind] // добавлено 15.07.12
    else                                       // добавлено 15.07.12
    begin
      if not E.Asked or
        (AKind = asNoLink) then                // добавлено 08.10.14
    ...
    if Caddy.NoAsk then          // добавлено 15.07.12
      Beeper.Say(E.AlarmStatus)  // добавлено 15.07.12
    else                         // добавлено 15.07.12
...
begin
  ...
  begin
    ...
    if Caddy.NoAsk and (ActiveAlarmLog.Count = 0) then // добавлено 15.07.12
      Beeper.ShortUp;                                  // добавлено 15.07.12
  end;
end;
...
begin
  ...
  bkSpeaker:  begin
    ...
    if (asBadPV in NowSay) or //(asNoLink in NowSay) or // коммент 08.10.14
