...
type
  ...
  private
    ...
    procedure SetOPRAW(const Value: Single);
    procedure SetPVRAW(const Value: Single);
    procedure SetSPRAW(const Value: Single);
    procedure SetHHRAW(const Value: Single);
    procedure SetHIRAW(const Value: Single);
    procedure SetLLRAW(const Value: Single);
    procedure SetLORAW(const Value: Single);
    procedure SetGraphType(const Value: TGraphType);
  protected
    procedure Paint; override;
  public
    constructor Create(AOwner: TComponent); override;
    property PVRAW: Single read FPVRAW write SetPVRAW;
    property SPRAW: Single read FSPRAW write SetSPRAW;
    property OPRAW: Single read FOPRAW write SetOPRAW;
    property HHRAW: Single read FHHRAW write SetHHRAW;
    property HIRAW: Single read FHIRAW write SetHIRAW;
    property LORAW: Single read FLORAW write SetLORAW;
    property LLRAW: Single read FLLRAW write SetLLRAW;
...
//=============
  ...
  begin
    Canvas.Pen.Width:=1;
    Canvas.Pen.Style:=psSolid;
    Canvas.Pen.Color:=clYellow; //clOlive;
    Canvas.Brush.Color:=clYellow; //clOlive;
...
procedure TRxGraph.SetHHRAW(const Value: Single);
...
procedure TRxGraph.SetHIRAW(const Value: Single);
var Wid: Integer; R: TRect;
begin
...
procedure TRxGraph.SetLLRAW(const Value: Single);
var Wid: Integer; R: TRect;
begin
...
procedure TRxGraph.SetLORAW(const Value: Single);
var Wid: Integer; R: TRect;
begin
...
procedure TRxGraph.SetOPRAW(const Value: Single);
...
procedure TRxGraph.SetPVRAW(const Value: Single);
...
procedure TRxGraph.SetSPRAW(const Value: Single);
