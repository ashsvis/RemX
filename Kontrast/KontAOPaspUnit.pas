...
type
  TKontAOPaspForm = class(TForm,IEntity)
    Panel1: TPanel;
    PTNameDesc: TLabel;
    PTDesc: TLabel;
...
var
  KontAOPaspForm: TKontAOPaspForm;
...
procedure TKontAOPaspForm.ConnectEntity(Entity: TEntity);
var sFormat: string; k: Double;
begin
  E:=Entity as TKontAnaOut;
...
procedure TKontAOPaspForm.ConnectImageList(ImageList: TImageList);
begin
// Stub
end;

procedure TKontAOPaspForm.UpdateRealTime;
...
procedure TKontAOPaspForm.FormCreate(Sender: TObject);
begin
...
procedure TKontAOPaspForm.FormResize(Sender: TObject);
begin
  RxGraph.Left:=10;
...
procedure TKontAOPaspForm.PVHHTPMouseDown(Sender: TObject;
...
procedure TKontAOPaspForm.PVHHTPMouseEnter(Sender: TObject);
begin
...
procedure TKontAOPaspForm.PVHHTPMouseLeave(Sender: TObject);
begin
  with Sender as TLabel do
    TShape(Tag).Pen.Color:=clBlack;
end;

procedure TKontAOPaspForm.ButtonToDataBaseClick(Sender: TObject);
begin
  E.ShowEditor(Monitor.MonitorNum);
end;

procedure TKontAOPaspForm.PVSourceDblClick(Sender: TObject);
begin
  E.ShowParentPassport(Monitor.MonitorNum);
end;

procedure TKontAOPaspForm.ButtonToMainScreenClick(Sender: TObject);
begin
