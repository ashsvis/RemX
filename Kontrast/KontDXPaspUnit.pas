...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, EntityUnit, KontrastUnit;

type
  TKontDXPaspForm = class(TForm,IEntity)
    Panel1: TPanel;
    PTNameDesc: TLabel;
    PTDesc: TLabel;
...
var
  KontDXPaspForm: TKontDXPaspForm;
...
procedure TKontDXPaspForm.ConnectEntity(Entity: TEntity);
begin
...
//-------------------------------------
  ...
  Kind.Caption:=E.PropsValue(4);
  Offset.Caption:=E.PropsValue(5);
  WaitTime.Caption:=E.PropsValue(20);
  UpdateRealTime;
end;

procedure TKontDXPaspForm.ConnectImageList(ImageList: TImageList);
begin
// Stub
end;

procedure TKontDXPaspForm.UpdateRealTime;
var k: TAlarmState;
begin
...
procedure TKontDXPaspForm.FormCreate(Sender: TObject);
begin
...
procedure TKontDXPaspForm.FormResize(Sender: TObject);
begin
...
procedure TKontDXPaspForm.AlarmOnMouseDown(Sender: TObject;
...
procedure TKontDXPaspForm.AlarmOnMouseEnter(Sender: TObject);
begin
...
procedure TKontDXPaspForm.AlarmOnMouseLeave(Sender: TObject);
begin
  with Sender as TLabel do
    TShape(Tag).Pen.Color:=clBlack;
end;

procedure TKontDXPaspForm.ButtonToDataBaseClick(Sender: TObject);
begin
  E.ShowEditor(Monitor.MonitorNum);
end;

procedure TKontDXPaspForm.PVSourceDblClick(Sender: TObject);
begin
  E.ShowParentPassport(Monitor.MonitorNum);
end;

procedure TKontDXPaspForm.ButtonToMainScreenClick(Sender: TObject);
begin
