...
type
  TKontKDEditForm = class(TBaseEditForm)
    ListView1: TListView;
    ListView2: TListView;
    Splitter1: TSplitter;
...
var
  KontKDEditForm: TKontKDEditForm;
...
procedure TKontKDEditForm.BaseFresh(var Mess: TMessage);
begin
  UpdateRealTime;
end;

procedure TKontKDEditForm.ConnectBaseEditor(var Mess: TMessage);
begin
  ConnectImageList(TImageList(Mess.WParam));
  ConnectEntity(TEntity(Mess.LParam));
end;

procedure TKontKDEditForm.ConnectEntity(Entity: TEntity);
var i: integer;
begin
...
procedure TKontKDEditForm.ConnectImageList(ImageList: TImageList);
begin
  ListView1.SmallImages:=ImageList;
  ListView2.SmallImages:=ImageList;
end;

procedure TKontKDEditForm.ListView2DblClick(Sender: TObject);
var E: TEntity;
begin
...
procedure TKontKDEditForm.ListView1DblClick(Sender: TObject);
begin
...
procedure TKontKDEditForm.UpdateRealTime;
var L: TListItem;
begin
...
procedure TKontKDEditForm.PopupMenu1Popup(Sender: TObject);
...
procedure TKontKDEditForm.ChangeTextClick(Sender: TObject);
...
procedure TKontKDEditForm.ChangeFetchClick(Sender: TObject);
...
procedure TKontKDEditForm.ChangeBooleanClick(Sender: TObject);
...
procedure TKontKDEditForm.PopupMenu2Popup(Sender: TObject);
...
procedure TKontKDEditForm.ChangeLinkClick(Sender: TObject);
...
procedure TKontKDEditForm.DeleteLinkClick(Sender: TObject);
...
procedure TKontKDEditForm.ChangeIntegerClick(Sender: TObject);
  ...
  begin
    ...
    begin
      case L.Index of
        ...
        3: if InRange(V,1,30) then
           begin
             E.Block:=V;
             L.SubItems[0]:=Format('%d',[E.Block]);
           end
           else
             raise ERangeError.Create('Значение вне допустимых границ (1..30)!');
      end;
