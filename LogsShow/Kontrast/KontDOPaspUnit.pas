...
type
  TKontDOPaspForm = class(TForm,IEntity)
    Panel1: TPanel;
    PTNameDesc: TLabel;
    PTDesc: TLabel;
...
var
  KontDOPaspForm: TKontDOPaspForm;
...
procedure TKontDOPaspForm.ConnectEntity(Entity: TEntity);
begin
...
procedure TKontDOPaspForm.ConnectImageList(ImageList: TImageList);
begin
// Stub
end;

procedure TKontDOPaspForm.UpdateRealTime;
var k: TAlarmState;
begin
...
procedure TKontDOPaspForm.FormCreate(Sender: TObject);
begin
...
procedure TKontDOPaspForm.FormResize(Sender: TObject);
begin
...
procedure TKontDOPaspForm.AlarmOnMouseDown(Sender: TObject;
...
procedure TKontDOPaspForm.AlarmOnMouseEnter(Sender: TObject);
begin
...
procedure TKontDOPaspForm.AlarmOnMouseLeave(Sender: TObject);
begin
  with Sender as TLabel do
    TShape(Tag).Pen.Color:=clBlack;
end;

procedure TKontDOPaspForm.ButtonToDataBaseClick(Sender: TObject);
begin
  E.ShowEditor(Monitor.MonitorNum);
end;

procedure TKontDOPaspForm.PVSourceDblClick(Sender: TObject);
begin
  E.ShowParentPassport(Monitor.MonitorNum);
end;

procedure TKontDOPaspForm.ButtonToMainScreenClick(Sender: TObject);
begin
