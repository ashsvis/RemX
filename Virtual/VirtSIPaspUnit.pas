...
type
  TVirtSIPaspForm = class(TForm,IEntity)
    Panel1: TPanel;
    PTNameDesc: TLabel;
    PTDesc: TLabel;
...
var
  VirtSIPaspForm: TVirtSIPaspForm;
...
procedure TVirtSIPaspForm.ConnectEntity(Entity: TEntity);
...
begin
  ...
  KindInfo.Caption:=ASysInfoKind[E.Kind];
  Koeff.Caption:=ASizeKoeff[E.Koeff];
//-------------------------------------
...
procedure TVirtSIPaspForm.ConnectImageList(ImageList: TImageList);
begin
// Stub
end;

procedure TVirtSIPaspForm.UpdateRealTime;
...
procedure TVirtSIPaspForm.FormCreate(Sender: TObject);
begin
...
procedure TVirtSIPaspForm.FormResize(Sender: TObject);
begin
  RxGraph.Left:=10;
...
procedure TVirtSIPaspForm.PVHHTPMouseDown(Sender: TObject;
...
procedure TVirtSIPaspForm.PVHHTPMouseEnter(Sender: TObject);
begin
...
procedure TVirtSIPaspForm.PVHHTPMouseLeave(Sender: TObject);
begin
  with Sender as TLabel do
    TShape(Tag).Pen.Color:=clBlack;
end;

procedure TVirtSIPaspForm.ButtonToDataBaseClick(Sender: TObject);
begin
  E.ShowEditor(Monitor.MonitorNum);
end;

procedure TVirtSIPaspForm.PVSourceDblClick(Sender: TObject);
begin
  E.ShowParentPassport(Monitor.MonitorNum);
end;

procedure TVirtSIPaspForm.ButtonToMainScreenClick(Sender: TObject);
begin
