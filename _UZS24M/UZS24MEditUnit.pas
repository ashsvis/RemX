...
uses
  ...
  Dialogs, ComCtrls, EntityUnit, UZS24MUnit, ExtCtrls, Menus;

type
  TUZS24MEditForm = class(TBaseEditForm)
    ListView1: TListView;
    ListView2: TListView;
    Splitter1: TSplitter;
...
var
  UZS24MEditForm: TUZS24MEditForm;
...
procedure TUZS24MEditForm.BaseFresh(var Mess: TMessage);
begin
  UpdateRealTime;
end;

procedure TUZS24MEditForm.ConnectBaseEditor(var Mess: TMessage);
begin
  ConnectImageList(TImageList(Mess.WParam));
  ConnectEntity(TEntity(Mess.LParam));
end;

procedure TUZS24MEditForm.ConnectEntity(Entity: TEntity);
var i: integer;
begin
...
procedure TUZS24MEditForm.ConnectImageList(ImageList: TImageList);
begin
  ListView1.SmallImages:=ImageList;
  ListView2.SmallImages:=ImageList;
end;

procedure TUZS24MEditForm.ListView2DblClick(Sender: TObject);
var E: TEntity;
begin
...
procedure TUZS24MEditForm.ListView1DblClick(Sender: TObject);
begin
...
procedure TUZS24MEditForm.UpdateRealTime;
var L: TListItem;
begin
...
procedure TUZS24MEditForm.PopupMenu1Popup(Sender: TObject);
...
procedure TUZS24MEditForm.ChangeTextClick(Sender: TObject);
...
procedure TUZS24MEditForm.ChangeFetchClick(Sender: TObject);
...
procedure TUZS24MEditForm.ChangeBooleanClick(Sender: TObject);
...
procedure TUZS24MEditForm.PopupMenu2Popup(Sender: TObject);
...
procedure TUZS24MEditForm.ChangeLinkClick(Sender: TObject);
...
begin
  ...
  try
    ...
    begin
      ...
      while R <> nil do
      begin
        if not Assigned(R.SourceEntity) and not R.IsComposit and
           R.IsDigit and not R.IsParam and R.IsVirtual then
          List.Add(R);
        R:=R.NextEntity;
      end;
...
procedure TUZS24MEditForm.DeleteLinkClick(Sender: TObject);
...
procedure TUZS24MEditForm.ChangeIntegerClick(Sender: TObject);
