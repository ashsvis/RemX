...
resourcestring
  clNameBlack = 'Черный';
  clNameMaroon = 'Малиновый';
  clNameGreen = 'Зеленый';
  clNameOlive = 'Оливковый';
  clNameNavy = 'Темно-синий';
  clNamePurple = 'Сиреневый';
  clNameTeal = 'Бирюзовый';
  clNameGray = 'Темно-серый';
  clNameSilver = 'Светло-серый';
  clNameRed = 'Красный';
  clNameLime = 'Светло-зеленый';
  clNameYellow = 'Желтый';
  clNameBlue = 'Синий';
  clNameFuchsia = 'Розовый';
  clNameAqua = 'Голубой';
  clNameWhite = 'Белый';
  clNameMoneyGreen = 'Денежный';
  clNameSkyBlue = 'Небесно-голубой';
  clNameCream = 'Кремовый';
  clNameMedGray = 'Серый';
  clNameActiveBorder = 'Активная рамка';
  clNameActiveCaption = 'Активный заголовок';
  clNameAppWorkSpace = 'Рабочая область';
  clNameBackground = 'Фон';
  clNameBtnFace = 'Панель';
  clNameBtnHighlight = 'Блик панели';
  clNameBtnShadow = 'Тень панели';
  clNameBtnText = 'Текст панели';
  clNameCaptionText = 'Текст заголовка';
  clNameDefault = 'По умолчанию';
  clNameGradientActiveCaption = 'Градиент активного заголовка';
  clNameGradientInactiveCaption = 'Градиент неактивного заголовка';
  clNameGrayText = 'Неактивный текст';
  clNameHighlight = 'Блик фона';
  clNameHighlightText = 'Блик текста';
  clNameInactiveBorder = 'Неактивная рамка';
  clNameInactiveCaption = 'Неактивный заголовок';
  clNameInactiveCaptionText = 'Текст неактивного заголовка';
  clNameInfoBk = 'Фон подсказки';
  clNameInfoText = 'Текст подсказки';
  clNameMenu = 'Фон меню';
  clNameMenuText = 'Текст меню';
  clNameNone = 'Нет';
  clNameScrollBar = 'Линейка прокрутки';
  clName3DDkShadow = '3D темный';
  clName3DLight = '3D светлый';
  clNameWindow = 'Фон окна';
  clNameWindowFrame = 'Панель окна';
  clNameWindowText = 'Текст окна';
