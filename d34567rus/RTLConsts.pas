...
// Kylix2 и Kylix3 определяют VER140
// запретить для Kylix2:
{$ifdef linux}
  {$undef VER140}
  {$define VER150}
{$endif}
...
{$ENDIF}
  ...
  SThreadCreateError = 'Ошибка создания нити (трэда): %s';
  SThreadError = 'Ошибка нити (трэда): %s (%d)';
